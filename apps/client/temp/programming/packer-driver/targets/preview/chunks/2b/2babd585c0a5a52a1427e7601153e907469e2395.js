    ...
    execute: function () {
      ...
      _export("ActorManager", ActorManager = (_dec = ccclass('ActorManager'), _dec(_class = class ActorManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        init(data) {
          ...
          var weaponPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          ...
          if (weaponPrefab) {
            var weaponNode = instantiate(weaponPrefab);
        ...
        renderPosition(data) {
          ...
          var newPos = new Vec3(position.x, position.y);
        ...
        renderAngle(data) {
          ...
          var side = Math.sign(direction.x ** 2 + direction.y ** 2);
