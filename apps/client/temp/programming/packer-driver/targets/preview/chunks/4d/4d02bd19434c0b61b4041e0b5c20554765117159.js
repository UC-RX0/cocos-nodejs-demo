      ...
      _export("BattleController", BattleController = class BattleController {
        ...
        static renderActor() {
          for (var data of (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            if (!actor) {
              var actorPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
        ...
        static renderBullet() {
          for (var data of (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            var bullet = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).Instance.bulletMap.get(id);

            if (!bullet) {
              var bulletPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
        ...
        static initMap() {
          //地图初始化
          var mapPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
        ...
        static loadRes() {
          ...
          for (var type in _crd && EntityTypeEnum === void 0 ? (_reportPossibleCrUseOfEntityTypeEnum({
            error: Error()
          ...
          var _loop2 = function _loop2(_type) {
            var p = (_crd && ResourceManager === void 0 ? (_reportPossibleCrUseOfResourceManager({
              ...
              error: Error()
            }), TexturePathEnum) : TexturePathEnum)[_type], SpriteFrame).then(res => (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).Instance.setTextureMap(_type, res));
            list.push(p);
          };
