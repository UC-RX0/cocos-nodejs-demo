    ...
    execute: function () {
      ...
      _export("HallManager", HallManager = (_dec = ccclass('HallManager'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Prefab), _dec(_class = (_class2 = class HallManager extends Component {
        ...
        renderRoom(_ref) {
          ...
          for (var c of this.RoomList.children) {
            c.active = false;
          }

          while (this.RoomList.children.length < Rooms.length) {
            var _c = instantiate(this.RoomPrefab);

            _c.active = false;
            _c.parent = this.RoomList;
          }

          for (var i = 0; i < Rooms.length; i++) {
            var data = Rooms[i];
            var node = this.RoomList.children[i];
        ...
        renderPlayer(_ref2) {
          ...
          for (var c of this.PlayerList.children) {
            c.active = false;
          }

          while (this.PlayerList.children.length < Players.length) {
            var _c2 = instantiate(this.PlayerPrefab);

            _c2.active = false;
            _c2.parent = this.PlayerList;
          }

          for (var i = 0; i < Players.length; i++) {
            var data = Players[i];
            var node = this.PlayerList.children[i];
