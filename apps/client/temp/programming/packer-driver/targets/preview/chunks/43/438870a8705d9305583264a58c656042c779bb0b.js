      ...
      _export("BattleManager", BattleManager = (_dec = ccclass('BattleManager'), _dec(_class = class BattleManager extends Component {
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            _this.clearGame(); //网络模块
            //游戏模块


            var list = (_crd && BattleController === void 0 ? (_reportPossibleCrUseOfBattleController({
              error: Error()
            }), BattleController) : BattleController).loadRes();
            yield Promise.all([...list, _this.connectServer()]);
            var {
              success,
              error,
              res
        ...
        connectServer() {
          ...
          return _asyncToGenerator(function* () {
            //连接服务器
            if (!(yield (_crd && NetworkManager === void 0 ? (_reportPossibleCrUseOfNetworkManager({
              error: Error()
        ...
        initMap() {
          //地图初始化
          var mapPrefab = (_crd && BattleController === void 0 ? (_reportPossibleCrUseOfBattleController({
            error: Error()
        ...
        renderActor() {
          var renderActorData = (_crd && BattleController === void 0 ? (_reportPossibleCrUseOfBattleController({
            error: Error()
          ...
          var am = actor.addComponent(_crd && ActorManager === void 0 ? (_reportPossibleCrUseOfActorManager({
            error: Error()
        ...
        */
        ...
        renderBullet() {
          var renderBulletData = (_crd && BattleController === void 0 ? (_reportPossibleCrUseOfBattleController({
            error: Error()
          ...
          var bm = bullet.addComponent(_crd && BulletManager === void 0 ? (_reportPossibleCrUseOfBulletManager({
            error: Error()
        ...
        handleServerSync(_ref) {
          ...
          for (var item of this.pendingInputs) {
            (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
